...
def Draw_Classification_Map(label, name: str, scale: float = 4.0, dpi: int = 400):
    ...
    :return: null
    '''
    ip_colors=np.array([[0,0,126],[1,0,204],[0,8,255],[0,77,255],[0,143,255],[1,212,255],[42,254,204],[96,255,153],[151,255,96],[14,255,206],[255,231,1],[255,168,3],[255,103,0],[255,41,0],[204,0,1],[126,0,1],])
    fig, ax = plt.subplots()
    numlabel = np.array(label)
    v = spy.imshow(classes=numlabel.astype(np.int16), fignum=fig.number,colors=ip_colors)
    ax.set_axis_off()
